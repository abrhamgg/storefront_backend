...
var OrderStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [o.user_id, 'active'])];
                    case 2:
                        result = _a.sent();
                        conn.release;
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Cannot create orders. Error: ".concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrderStore.prototype.show_current_orders = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Cannot get orders by user_id: ".concat(user_id, ". Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrderStore.prototype.show_completed_orders = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Cannot get orders by user_id: ".concat(user_id, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    OrderStore.prototype.addProduct = function (quantity, order_id, product_id) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, sql1, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 2:
                        result = _a.sent();
                        sql1 = "UPDATE orders SET status='completed' WHERE id = ($1)";
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Could not add product ".concat(product_id));
                    case 4: return [2 /*return*/];
                }
            });
        });
