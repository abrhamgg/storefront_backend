...
var ProductStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not find a product with id ".concat(id, ". Error: ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    ProductStore.prototype.create = function (p) {
        return __awaiter(this, void 0, void 0, function () {
            var sql_1, conn_1, result_1, sql, conn, result, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
                        if (!p.category) return [3 /*break*/, 3];
                        sql_1 = "INSERT INTO products (name, price, category) VALUES($1, $2, $3) RETURNING *";
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                        conn_1 = _a.sent();
                        return [4 /*yield*/, conn_1.query(sql_1, [p.name, p.price, p.category])];
                    case 2:
                        result_1 = _a.sent();
                        conn_1.release();
                    ...
                    case 6:
                        err_3 = _a.sent();
                        throw new Error("Cannot create a product ".concat(err_3));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Cannot get products with category ".concat(category, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
