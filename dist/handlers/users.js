        ...
        switch (_a.label) {
            ...
            case 2:
                ...
                if (new_user == -1) {
                    ...
                    token = jsonwebtoken_1["default"].sign({ user: new_user }, String(process.env.TOKEN_SECRET));
                    res.json(token);
                }
                return [3 /*break*/, 4];
            case 3:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, store["delete"](user.username, user.password)];
            case 1:
                result = _a.sent();
                if (result === 0) {
                    res.status(200);
