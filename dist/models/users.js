...
var UserStore = /** @class */ (function () {
    ...
    UserStore.prototype.create = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, hash, sql2, checked_user, result, user, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 1:
                        ...
                        sql2 = "SELECT * FROM users WHERE username = ($1)";
                        return [4 /*yield*/, conn.query(sql2, [u.username])];
                    case 2:
                        checked_user = _a.sent();
                    ...
                    case 4:
                        err_3 = _a.sent();
                        throw new Error("Cannot create user. Error ".concat(err_3));
                    case 5: return [2 /*return*/];
                }
            });
        });
    };
    UserStore.prototype["delete"] = function (username, password) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, verification, sql, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!(verification !== -1)) return [3 /*break*/, 4];
